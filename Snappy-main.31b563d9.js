...
var _switch = require("./js/switch");
var _noteModal = require("./js/note-modal");
var _sidebar = require("./js/sidebar");
var _googleApiJs = require("./js/google-api.js");
var _settingsJs = require("./js/settings.js");
window.addEventListener('load', ()=>{
    (0, _googleApiJs.gapiLoaded)();
    (0, _googleApiJs.gisLoaded)();
});
...
},{"./js/switch":"eUoBZ","./js/note-modal":"fqPkS","./js/sidebar":"jWbWy","./js/google-api.js":"5NvAF","./js/settings.js":"j9rK7"}],"eUoBZ":[function(require,module,exports,__globalThis) {
...
const checkThemeChange = ()=>{
    if (localStorageTheme === null && window.matchMedia('(prefers-color-cheme: dark)').matches) setDarkMode();
    else if (localStorageTheme && window.matchMedia('(prefers-color-cheme: dark)').matches) setDarkMode();
    else setLightMode();
};
const setDarkMode = ()=>{
    body.classList = 'dark';
...
},{}],"fqPkS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _googleApiJs = require("./google-api.js");
...
function renderTasks(tasksToRender = tasks) {
    const $list = (0, _jqueryDefault.default)("#taskList");
    $list.empty();
    ...
    sorted.forEach((task)=>{
        ...
        const time = startStr && endStr ? `${startStr} \u{2014} ${endStr}` : startStr || endStr || "";
        const html = `
        <article class="note-card" data-id="${task.id}">
            ...
            <div class="note-bottom">
                ...
                ${task.location ? `<span class="note-location">\u{1F4CD} ${escapeHtml(task.location)}</span>` : ""}
            </div>
        </article>`;
        $list.append(html);
    });
...
function renderSettingsPage() {
    const $list = (0, _jqueryDefault.default)("#taskList");
    const lang = (0, _settingsJs.getCurrentLang)();
    const userName = localStorage.getItem("user-name") || "";
    const t = (0, _settingsJs.translations)[lang] || (0, _settingsJs.translations)['en'];
    $list.empty().append(`
        ...
        <div class="status-card">
            ...
            <div>
                ...
                <select id="settings-lang">
                    <option value="ua" ${lang === "ua" ? "selected" : ""}>\u{423}\u{43A}\u{440}\u{430}\u{457}\u{43D}\u{441}\u{44C}\u{43A}\u{430}</option>
  ...
  `);
    (0, _settingsJs.initSettingsListeners)();
    (0, _jqueryDefault.default)("#backFromSettings").off("click").on("click", ()=>{
        history.pushState({
            view: "notes"
        }, "", "?view=notes");
        showNotesView();
...
function showNotesView() {
    const lang = (0, _settingsJs.getCurrentLang)();
    const t = (0, _settingsJs.translations)[lang] || (0, _settingsJs.translations)['en'];
    (0, _jqueryDefault.default)("#taskList").removeClass("settings-view");
    (0, _jqueryDefault.default)(".notes_title").text(t.notesTitle);
    (0, _jqueryDefault.default)(".notes_btn-wrap").show();
    renderTasks();
}
function showSettingsView() {
    const lang = (0, _settingsJs.getCurrentLang)();
    const t = (0, _settingsJs.translations)[lang] || (0, _settingsJs.translations)['en'];
    (0, _jqueryDefault.default)("#taskList").removeClass("list-view");
    (0, _jqueryDefault.default)("#taskList").addClass("settings-view");
    (0, _jqueryDefault.default)(".notes_title").text(t.settingsTitle);
    (0, _jqueryDefault.default)(".notes_btn-wrap").hide();
    renderSettingsPage();
}
function openModal(mode = "new", task = null) {
    const lang = (0, _settingsJs.getCurrentLang)();
    const t = (0, _settingsJs.translations)[lang] || (0, _settingsJs.translations)['en'] || (0, _settingsJs.translations)['cz'];
    if (!t) {
        console.error("\u041F\u043E\u043C\u0438\u043B\u043A\u0430: \u041F\u0435\u0440\u0435\u043A\u043B\u0430\u0434\u0438 \u043D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u0456!");
        return;
    }
    (0, _jqueryDefault.default)("#taskModal").removeClass('hidden');
    (0, _jqueryDefault.default)("#modalTitle").text(mode === "new" ? t.modalNewTitle : t.modalEditTitle);
    const $fields = (0, _jqueryDefault.default)(".modal-field span");
    ...
    (0, _jqueryDefault.default)("#taskSummary").attr('placeholder', t.summaryPlaceholder);
    (0, _jqueryDefault.default)("#taskDescription").attr('placeholder', t.descriptionPlaceholder);
    (0, _jqueryDefault.default)("#taskLocation").attr('placeholder', t.locationPlaceholder);
    if (mode === "new") {
        (0, _jqueryDefault.default)("#taskSummary").val("");
        (0, _jqueryDefault.default)("#taskDescription").val("");
        (0, _jqueryDefault.default)("#taskStart").val("");
        (0, _jqueryDefault.default)("#taskEnd").val("");
        (0, _jqueryDefault.default)("#taskLocation").val("");
    } else {
        (0, _jqueryDefault.default)("#taskSummary").val(task.summary);
        (0, _jqueryDefault.default)("#taskDescription").val(task.description || "");
        (0, _jqueryDefault.default)("#taskStart").val(toInputDateTime(task.start));
        (0, _jqueryDefault.default)("#taskEnd").val(toInputDateTime(task.end));
        (0, _jqueryDefault.default)("#taskLocation").val(task.location || "");
    }
    (0, _jqueryDefault.default)('#saveTaskBtn').data("mode", mode).data("id", task?.id ?? null).text(mode === "new" ? t.createBtn : t.saveBtn);
    (0, _jqueryDefault.default)('#cancelTaskBtn').text(t.cancelBtn);
}
function closeModal() {
    (0, _jqueryDefault.default)("#taskModal").addClass("hidden");
}
(0, _jqueryDefault.default)(function() {
    loadTasks();
    renderTasks();
    (0, _settingsJs.initSettingsListeners)();
    (0, _settingsJs.updateUserGreeting)();
    const params = new URLSearchParams(window.location.search);
    ...
    (0, _jqueryDefault.default)('.content_item:contains("Note")').on("click", function(e) {
        e.preventDefault();
        history.pushState({
            view: "notes"
        }, "", "?view=notes");
        showNotesView();
        (0, _jqueryDefault.default)("#sidebar_toggle").prop("checked", false);
    });
    (0, _jqueryDefault.default)('.content_item:contains("Settings")').on("click", function(e) {
        e.preventDefault();
        history.pushState({
            view: "settings"
        }, "", "?view=settings");
    ...
    (0, _jqueryDefault.default)('input[placeholder="Search..."]').on("input", function() {
        const query = (0, _jqueryDefault.default)(this).val().toLowerCase();
        const filtered = tasks.filter((t)=>t.summary.toLowerCase().includes(query) || t.description && t.description.toLowerCase().includes(query));
        renderTasks(filtered);
    });
    (0, _jqueryDefault.default)("#form-note_btn").on("click", function() {
        if ((0, _jqueryDefault.default)("#taskList").hasClass("settings-view")) return;
        (0, _jqueryDefault.default)("#taskList").toggleClass("list-view");
        const isList = (0, _jqueryDefault.default)("#taskList").hasClass("list-view");
        window.location.hash = isList ? "view=list" : "view=grid";
        const $icon = (0, _jqueryDefault.default)(this).find("i");
        $icon.toggleClass("icon-list-bulleted icon-apps");
    });
    (0, _jqueryDefault.default)(`#add-note_btn`).on("click", ()=>openModal("new"));
    (0, _jqueryDefault.default)("#cancelTaskBtn").on("click", closeModal);
    (0, _jqueryDefault.default)("#saveTaskBtn").on("click", async function() {
        const t = (0, _settingsJs.translations)[(0, _settingsJs.getCurrentLang)()];
        const mode = (0, _jqueryDefault.default)(this).data('mode');
        const id = Number((0, _jqueryDefault.default)(this).data('id'));
        const summary = (0, _jqueryDefault.default)("#taskSummary").val().trim();
        const description = (0, _jqueryDefault.default)("#taskDescription").val().trim();
        const startVal = (0, _jqueryDefault.default)("#taskStart").val();
        const endVal = (0, _jqueryDefault.default)("#taskEnd").val();
        const locationVal = (0, _jqueryDefault.default)("#taskLocation").val();
        if (!summary) {
        ...
        if (mode === "new") {
            ...
            tasks.push(newTask);
            try {
                const googleId = await (0, _googleApiJs.syncNoteToCalendar)(summary, description, start, end, location);
            ...
            if (index !== -1) {
                ...
                if (oldTask.googleEventId) try {
                    await (0, _googleApiJs.updateCalendarEvent)(oldTask.googleEventId, summary, description, start, end, location);
                } catch (err) {
    ...
    (0, _jqueryDefault.default)("#taskList").on("click", ".note-edit-btn", function() {
        const id = Number((0, _jqueryDefault.default)(this).closest(".note-card").data("id"));
        const task = tasks.find((t)=>t.id === id);
        if (task) openModal("edit", task);
    });
    (0, _jqueryDefault.default)("#taskList").on("click", ".note-delete-btn", async function() {
        const id = Number((0, _jqueryDefault.default)(this).closest(".note-card").data("id"));
        const taskToDelete = tasks.find((t)=>t.id === id);
        if (!confirm("Delete this note?")) return;
        if (taskToDelete && taskToDelete.googleEventId) try {
            await (0, _googleApiJs.deleteCalendarEvent)(taskToDelete.googleEventId);
        } catch (err) {
    ...
    (0, _jqueryDefault.default)(document).on("app:langChanged", ()=>{
        const v = new URLSearchParams(window.location.search).get("view");
        if (v === "settings") showSettingsView();
        else showNotesView();
        (0, _settingsJs.updateUserGreeting)();
...
},{"jquery":"dlwdd","./google-api.js":"5NvAF","./settings.js":"j9rK7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dlwdd":[function(require,module,exports,__globalThis) {
/*!
...
},{}],"5NvAF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gapiLoaded", ()=>gapiLoaded);
parcelHelpers.export(exports, "gisLoaded", ()=>gisLoaded);
parcelHelpers.export(exports, "syncNoteToCalendar", ()=>syncNoteToCalendar);
parcelHelpers.export(exports, "deleteCalendarEvent", ()=>deleteCalendarEvent);
parcelHelpers.export(exports, "updateCalendarEvent", ()=>updateCalendarEvent);
const CLIENT_ID = "739931462642-vmnl5oubeg2eg8638k11mh3nmm2r075d.apps.googleusercontent.com";
...
async function syncNoteToCalendar(title, description, startIso, endIso = null, location = null) {
    ...
    return new Promise((resolve, reject)=>{
        tokenClient.callback = async (resp)=>{
            ...
            const event = {
                ...
                'end': {
                    'dateTime': endIso || new Date(startIso ? new Date(startIso).getTime() + 3600000 : Date.now() + 3600000).toISOString(),
                    'timeZone': 'Europe/Prague'
                },
        ...
        if (gapi.client.getToken() === null) tokenClient.requestAccessToken({
            prompt: 'consent'
        });
...
async function updateCalendarEvent(googleEventId, title, description, startIso, endIso = null, location = null) {
...
},{}],"j9rK7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "translations", ()=>translations);
parcelHelpers.export(exports, "getCurrentLang", ()=>getCurrentLang);
parcelHelpers.export(exports, "updateUserGreeting", ()=>updateUserGreeting);
parcelHelpers.export(exports, "initSettingsListeners", ()=>initSettingsListeners);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const translations = {
    ua: {
...
function updateUserGreeting() {
    ...
    if (t && name) (0, _jqueryDefault.default)('#user-greeting').text(`${t.hello} ${name}!`);
    else (0, _jqueryDefault.default)('#user-greeting').text('');
}
function initSettingsListeners() {
    (0, _jqueryDefault.default)(document).on('input', '#settings-user-name', function() {
        localStorage.setItem('user-name', (0, _jqueryDefault.default)(this).val());
        updateUserGreeting();
    });
    (0, _jqueryDefault.default)(document).on('change', '#settings-lang', function() {
        const newLang = (0, _jqueryDefault.default)(this).val();
        const inputName = (0, _jqueryDefault.default)('#settings-user-name').val();
        if (inputName && inputName.trim()) localStorage.setItem('user-name', inputName.trim());
        localStorage.setItem('app-lang', newLang);
        updateUserGreeting();
        (0, _jqueryDefault.default)(document).trigger('app:langChanged');
    });
}

},{"jquery":"dlwdd","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jWbWy":[function(require,module,exports,__globalThis) {
document.querySelector('.page-blur-overlay').addEventListener('click', ()=>{
    document.getElementById('#sidebar_toggle').checked = false;
});

},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire1315", {})

//# sourceMappingURL=Snappy-main.31b563d9.js.map
